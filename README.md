...
Workforce structure and employee demographics
Performance distribution across departments and roles
Key drivers and patterns of employee attrition
Insights to support employee retention strategies
...
Employee demographics (age, gender, department, role)
Employment details (hire date, tenure, job role)
Performance metrics
...
2. Demographics & Performance Analysis

DAX measures and visuals were used to analyze employee demographics, job roles, and performance patterns across the organization. This helped identify variations in performance and engagement across different groups.

3. Attrition & Retention Analysis
...
DAX calculations
HR analytics and storytelling
Data visualization and report design


The final dashboard provides an interactive view of workforce dynamics and attrition drivers, enabling HR stakeholders to make more informed decisions around employee retention and workforce planning.
